...
if configManager.getBoolean(configKeys.VIP_SYSTEM_ENABLED) then
	...
	premiumDescription = "Enhance your gaming experience by gaining advantages:\n\n"
...
GameStore.Categories = {
		...
		offers = {
			{
				...
				name = "\nFull Mage Outfit\n",
				price = 3000,
				sexId = { female = 141, male = 130 },
				addon = 3,
				description = "Full Mage Outfit.",
			...
			},
			{
				...
				addon = 3,
				description = "Full Golden Outfit.",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON,
			},
			{
				icons = { "Outfit_Arbalester_Male_Addon_3.png", "Outfit_Arbalester_Female_Addon_3.png" },
				name = "\nRoyal Custume Outfit\n",
				price = 750,
				sexId = { female = 1456, male = 1457 },
				addon = 3,
				description = "Full Royal Custume Outfit.",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON,
			},
			{
				icons = { "Outfit_Arbalester_Male_Addon_3.png", "Outfit_Arbalester_Female_Addon_3.png" },
				...
				addon = 3,
				description = "Full Dragon Slayer Outfit.",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON,
			},
			{
				icons = { "Outfit_Arbalester_Male_Addon_3.png", "Outfit_Arbalester_Female_Addon_3.png" },
			...
			{
				icons = { "Outfit_Cave_Explorer_Male_Addon_3.png", "Outfit_Cave_Explorer_Female_Addon_3.png" },
				name = "Cave Explorer",
				price = 150,
			...
			},
			{
				...
				addon = 3,
				description = "Full Citizen Outfit.",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON,
			},
			{
				icons = { "Outfit_Crystal_Warlord_Male_Addon_3.png", "Outfit_Crystal_Warlord_Female_Addon_3.png" },
			...
			{
				icons = { "Outfit_Deepling_Male_Addon_3.png", "Outfit_Deepling_Female_Addon_3.png" },
				name = "Deepling",
				price = 150,
			...
			},
			{
				...
				addon = 3,
				description = "Full Hunter Outfit.",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON,
			},
			{
			...
			},
			{
				...
				addon = 3,
				description = "Full Knight Outfit.",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON,
			},
			{
			...
			},
			{
				...
				addon = 3,
				description = "Full Oriental Outfit.",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON,
			},
			{
			...
			{
				icons = { "Outfit_Soil_Guardian_Male_Addon_3.png", "Outfit_Soil_Guardian_Female_Addon_3.png" },
				name = "Soil Guardian",
				price = 150,
			...
			},
			{
				...
				addon = 3,
				description = "Full Wizard Outfit.",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON,
			},			
		},
	},
	...
	-- Extras ~ Usefull Things
	{
		...
		offers = {
			...
			},
			{
				...
				price = 200,
				itemtype = 60221,
				description = "Add 350 cham points to your character\n\nActivated when using the item",
	...
	
	{
		...
		name = "Underfox Shop",
		rookgaard = true,
		subclasses = { "Utilities", "Amuletos", "Rings", "Backpacks", "Promotion Scroll" },
	},
	-- Underfox Shop ~ Utilities
	{
		icons = { "Category_ExclusiveOffers.png" },
		name = "Utilities",
		parent = "Underfox Shop",
		rookgaard = true,
		state = GameStore.States.STATE_NONE,
		offers = {
			{
				name = "Portable Trader",
				price = 500,
				itemtype = 60064,
				count = 1,
				description = "Sell loots in your loot pounch. ",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
				home = true,
				movable = false,
			},
			{
				...
				itemtype = 60065,
				count = 1,
				description = "Compra runas por modal sem necessidade de voltar para city",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
				home = true,
				movable = false,
			},
			{
				name = "Ammunation Refiller",
				price = 500,
				itemtype = 60063,
				count = 1,
				description = "Compra Munic?o?es por modal sem necessidade de voltar para city",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
				home = true,
				movable = false,
			},
			...
			},
			{
				...
				itemtype = 37317,
				count = 1,
				description = "ticket to use at roulette",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				name = "Roulette Token",
		...
		offers = {
			{
				...
				itemtype = 36741,
				count = 1,
				description = "Aumenta 8% de dano elemental por 1 hora.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				...
				itemtype = 36734,
				count = 1,
				description = "Aumenta 8% de resistencia elemental por 1 hora.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
			...
			},
			{
				...
				itemtype = 36728,
				count = 1,
				description = "Dobra a contagem de bestiary por 1 hora.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				name = "Charm Upgrade",
				...
				itemtype = 36726,
				count = 1,
				description = "Dobra a chance da runa ativar.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
		},
	},
	-- Underfox Shop ~ Promotion Scroll
	{
		icons = { "Category_ExclusiveOffers.png" },
		...
		offers = {
			{
				...
				itemtype = 43946,
				count = 1,
				description = "Adiciona 3 pontos a sua roda de habilidade.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				...
				itemtype = 43947,
				count = 1,
				description = "Adiciona 5 pontos a sua roda de habilidade.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				...
				itemtype = 43948,
				count = 1,
				description = "Adiciona 9 pontos a sua roda de habilidade.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				...
				itemtype = 43949,
				count = 1,
				description = "Adiciona 13 pontos a sua roda de habilidade.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				...
				itemtype = 43950,
				count = 1,
				description = "Adiciona 20 pontos a sua roda de habilidade.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},	
		},
	},
