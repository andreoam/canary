...
keywordHandler:addKeyword({ "trip" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Arcadia}, {Ab'Dendriel}, {Venore}, {Svargrond}, {Yalahar} or {Edron?}" })
keywordHandler:addKeyword({ "passage" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Arcadia}, {Ab'Dendriel}, {Venore}, {Svargrond}, {Yalahar} or {Edron?}" })
keywordHandler:addKeyword({ "town" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Arcadia}, {Ab'Dendriel}, {Venore}, {Svargrond}, {Yalahar} or {Edron?}" })
keywordHandler:addKeyword({ "destination" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Arcadia}, {Ab'Dendriel}, {Venore}, {Svargrond}, {Yalahar} or {Edron?}" })
keywordHandler:addKeyword({ "sail" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Arcadia}, {Ab'Dendriel}, {Venore}, {Svargrond}, {Yalahar} or {Edron?}" })
keywordHandler:addKeyword({ "go" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {Thais}, {Arcadia}, {Ab'Dendriel}, {Venore}, {Svargrond}, {Yalahar} or {Edron?}" })
