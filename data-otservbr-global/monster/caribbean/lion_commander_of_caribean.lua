local mType = Game.createMonsterType("Lion Commander of Caribean")
local monster = {}
...
monster.summon = {
	maxSummons = 6,
	summons = {
		{ name = "Lion Archer of Caribean", chance = 100000, interval = 6000, count = 2 },
		{ name = "Lion Knight of Caribean", chance = 100000, interval = 6000, count = 2 },
		{ name = "Lion Warlock of Caribean", chance = 100000, interval = 6000, count = 2 },
	},
}
