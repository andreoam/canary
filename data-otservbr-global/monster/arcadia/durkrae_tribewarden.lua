local mType = Game.createMonsterType("Durkrae Tribewarden")
local monster = {}

monster.description = "a durkrae tribewarden"
...
monster.loot = {
	...
	{ name = "Wand of Starstorm", chance = 350},
	{ name = "Blue Crystal Shard", chance = 550},
	{ name = "Shard", chance = 800},
	{ name = "Crystal Sword", chance = 800},
	{ name = "Crystalline Arrow", chance = 800, maxCount = 20},
