local mType = Game.createMonsterType("Durkrae Toolshaper")
local monster = {}
...
monster.loot = {
	...
	{ name = "Taurus Mace", chance = 4000},
	{ name = "Furry Club", chance = 4300},
	{ name = "Diamond Sceptre", chance = 1000 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = -150, maxDamage = -350 },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -150, maxDamage = -450, range = 7, radius = 1, shootEffect = CONST_ANI_SMALLSTONE, target = true },
}
