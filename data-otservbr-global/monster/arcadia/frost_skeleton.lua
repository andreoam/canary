local mType = Game.createMonsterType("Frost Skeleton")
local monster = {}
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1560 },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_ICEDAMAGE, minDamage = 0, maxDamage = -1100, length = 8, spread = 0, effect = CONST_ME_ICEATTACK, target = false },
	...
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_ICEDAMAGE, minDamage = -300, maxDamage = -1750, length = 8, spread = 0, effect = CONST_ME_ICEAREA, target = false },
...
monster.defenses = {
	...
	{ name = "combat", interval = 3000, chance = 15, type = COMBAT_HEALING, minDamage =8200, maxDamage = 1500, effect = CONST_ME_MAGIC_BLUE, target = false },
}
