local config = {
    interval = 3000,
    texts = {
				{ pos = Position(32368, 32239, 6), text = 'Teleports', effects = {CONST_ME_DRAWBLOOD } },
				{ pos = Position(32371, 32239, 6), text = 'Trainers', effects = {CONST_ME_DRAWBLOOD } },
				{ pos = Position(32361, 32239, 7), text = 'Items Imbuements', effects = {CONST_ME_DRAWBLOOD } },
...
AnimatedText:interval(config.interval)
