local internalNpcName = "Accessories Merchant"
...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ text = "Vem que tá tendo" },
	{ text = "amulets and rings is here! xD " },
}
...
local npcShopItems = {}
for _, item in ipairs(SupplyShopConfigTable["rings"] or {}) do
	table.insert(npcShopItems, item)
end
for _, item in ipairs(SupplyShopConfigTable["amulets"] or {}) do
	table.insert(npcShopItems, item)
end
...
npcHandler:setMessage(MESSAGE_GREET, "Greetings, |PLAYERNAME|! I sell rings and amulets. Would you like to check my {trade}?")
