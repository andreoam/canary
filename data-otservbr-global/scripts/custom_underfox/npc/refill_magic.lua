...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ text = "Precisa de potios? runas? Eu tenho no precinho" },
	{ text = "Precinho de potions e runas é só aqui!." },
}
...
local npcShopItems = {}
for _, item in ipairs(SupplyShopConfigTable["runes"] or {}) do
	table.insert(npcShopItems, item)
end
for _, item in ipairs(SupplyShopConfigTable["potions"] or {}) do
	table.insert(npcShopItems, item)
end
