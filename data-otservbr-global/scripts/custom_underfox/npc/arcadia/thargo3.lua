...
local npcType = Game.createNpcType("Thargo (3)")
local npcConfig = {}
...
addTravelKeyword("arcadia", 170, Position(31581, 31602, 7))
...
-- Basic
keywordHandler:addKeyword({ "lands" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {rock castle}, {arcadia}, or {hall island}?" })
