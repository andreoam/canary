...
local npcType = Game.createNpcType("Thargo (2)")
local npcConfig = {}
...
-- Basic
keywordHandler:addKeyword({ "lands" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {rock castle}, {arcadia}, or {village}?" })
