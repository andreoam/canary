...
local npcType = Game.createNpcType("Thargo (4)")
local npcConfig = {}
...
-- Basic
keywordHandler:addKeyword({ "lands" }, StdModule.say, { npcHandler = npcHandler, text = "Where do you want to go? To {arcadia}, {village}, or {hall island}?" })
