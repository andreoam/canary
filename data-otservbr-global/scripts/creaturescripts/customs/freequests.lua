...
local questTable = {
	...
	{ storage = Storage.Quest.U7_4.DjinnWar.EfreetFaction.Start, storageValue = 0 },
	...
	{ storage = Storage.Quest.U7_4.DjinnWar.MaridFaction.Start, storageValue = 0 },
	...
	{ storage = Storage.Oramond.VotingPoints, storageValue = 1 },
	{ storage = Storage.Oramond.HarvestedRootCount, storageValue = 1 },
	{ storage = Storage.Oramond.TaskProbing, storageValue = 1 },
	{ storage = Storage.Oramond.DoorBeggarKing, storageValue = 1 },
	{ storage = Storage.Oramond.MissionAbandonedSewer, storageValue = 1 },
	{ storage = Storage.Oramond.DoorAbandonedSewer, storageValue = 1 },
